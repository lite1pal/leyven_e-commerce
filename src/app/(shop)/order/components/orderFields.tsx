import FormField from "@/app/(dashboard)/dashboard/products/edit/[id]/components/formField";
      ...
      <FormSection header="Доставка">
        ...
        <FormRadio
          ...
          options={[
            ...
            // {
            //   title: "Укрпошта Відділення",
            //   img: "https://www.ukrposhta.ua/uploads/files/shares/pin_2.png",
            // },
          ]}
        />
