    ...
    <Suspense>
      <Card className="m-4  mx-auto flex min-h-screen w-full flex-col gap-5 sm:w-1/2">
        <div className="flex flex-col gap-7">
          ...
          <p>
            Ласкаво просимо до магазину "ЛейВен" – вашого надійного партнера у
            світі догляду за тваринами та ветеринарії! Ми розуміємо, наскільки
            важливі ваші сімейні улюбленці, і саме тому ми створили цей магазин,
            щоб забезпечити їхні потреби та ваш спокій.
          </p>
          <p>
            <span className="font-bold">Наш асортимент:</span> У магазині
            "ЛейВен" ви знайдете широкий вибір товарів для догляду за вашими
            тваринами. Ми спеціалізуємося на кормах від провідних брендів,
            ветеринарних засобах та аксесуарах, щоб ваші улюбленці почували себе
          ...
          <p>
            Магазин "ЛейВен" – це місце, де ваші тварини отримають найкращий
            догляд, а ви – найкращий сервіс. Давайте разом робити життя ваших
            улюбленців яскравим і здоровим!
          </p>
        </div>
        <InfoItem
